#!/usr/bin/env bash
### Created by Peter Forret ( pforret ) on 2022-10-16
...
readonly script_created="2022-10-16"
...
Script:main() {
  ...
  case $action in
  multi)
    #TIP: use «$script_prefix multi» to create screenshots for all URLS in input file
    #TIP:> $script_prefix multi sites.txt
